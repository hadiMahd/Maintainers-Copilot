...
def upgrade() -> None:
    ...
    op.add_column("widget_configs", sa.Column("position", sa.String(20), nullable=False, server_default="bottom-right"))
    op.add_column("widget_configs", sa.Column("enabled_tools", postgresql.JSON(astext_type=sa.Text()), nullable=True))
