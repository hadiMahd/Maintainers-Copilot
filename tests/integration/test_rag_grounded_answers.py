...
def _make_fixture_golden_examples() -> list[dict]:
    return [
        {"question": "how to install numpy", "answer": "pip install numpy",
         "expected_chunks": ["chunk-1"], "source_type": "docs"},
        {"question": "what python version", "answer": "Python 3.11 or newer",
         "expected_chunks": ["chunk-2"], "source_type": "docs"},
        {"question": "what does ERR_PARSER_42 mean",
         "answer": "ERR_PARSER_42 means unexpected token",
         "expected_chunks": ["chunk-3"], "source_type": "docs",
         "disagreement_note": "Context may require cross-file retrieval"},
        {"question": "unknown topic not in corpus",
         "answer": "Insufficient evidence", "expected_chunks": [], "source_type": "docs",
         "disagreement_note": "Expected no retrieval; baseline may hallucinate"},
        {"question": "how to set up environment",
         "answer": "Python 3.11 plus pip install", "expected_chunks": ["chunk-2"],
         "source_type": "docs", "disagreement_note": "Answer ambiguous; both chunks may apply"},
    ]
